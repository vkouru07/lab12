...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Unable to reader line parent : child"); // throw a TreeException with a useful message
		...
		else
		{
			...
			if (parentNode == null) {							// If the parent node wasn't found, there must have been something wrong in the 
				throw new TreeException("Invalid data file");	// data file. Throw an exception.
			}
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("Invalid child");	// Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2);	// node whose name is name2
		if (node2 == null)
			throw new TreeException("Invalid child");	// Throw TreeException with a useful message
